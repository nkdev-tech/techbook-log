...
describe('book-search', () => {
  ...
  it('can get book info', async () => {
    ...
    const spy = vi.spyOn(globalThis, 'fetch').mockResolvedValue(new Response(JSON.stringify(mockData)))
  ...
  it('cannot get book info with api error', async () => {
    const spy = vi.spyOn(globalThis, 'fetch').mockRejectedValue(new Error('API error'))

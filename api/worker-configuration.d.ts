/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cc7749d089ff9e2d461dd120ee49da92)
// Runtime types generated with workerd@1.20260401.1 2026-04-02 nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
...
declare abstract class AiSearchItems {
     ...
     */
    upload(name: string, content: ReadableStream | ArrayBuffer | string, options?: AiSearchUploadItemOptions): Promise<AiSearchItemInfo>;
    /**
     ...
     */
    uploadAndPoll(name: string, content: ReadableStream | ArrayBuffer | string, options?: AiSearchUploadItemOptions): Promise<AiSearchItemInfo>;
    /**
     * Get an item by ID.
...
type ChatCompletionsInput = XOR<ChatCompletionsBase, {
